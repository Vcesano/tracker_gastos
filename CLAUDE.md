...
- [ ] **It 2 — Crédito**: alta de ComprasCredito, pantalla batch "Cargar resumen de tarjeta", vistas de compras y cuotas pendientes.
  ...
  - [ ] **2b — pantalla batch "Cargar resumen de tarjeta"** (la estrella): grilla prellenada por compra activa de la tarjeta, confirmación atómica.
  - [ ] **2c — vista Cuotas pendientes** + pulido.
